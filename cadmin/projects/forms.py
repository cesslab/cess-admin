...
class ProjectForm(forms.ModelForm):
    ...
    class Meta:
        model = Project
        fields = [
            'name', 'description', 'primary_investigators', 'research_assistants',
            # 'has_irb_cert', 'external_irb_approval', 'protocol', 'is_no_deception', 'has_grant_funding',
            # 'grant_agency', 'grant_funds_released', 'alt_source_funding'
              ]
